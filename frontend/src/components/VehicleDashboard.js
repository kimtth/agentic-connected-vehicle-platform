...
import { 
  Box, Typography, Paper, Grid, Slider, Switch, 
  FormControlLabel, Button, Card, CardContent, CircularProgress
} from '@mui/material';
import { styled } from '@mui/material/styles';
import { 
  Speed, LocalGasStation, Battery90, Thermostat, 
  AcUnit, WbSunny, VolumeUp, BluetoothAudio, Navigation, 
  DirectionsCar, Sync, Brightness6, DeviceThermostat
