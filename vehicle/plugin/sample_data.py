...
def generate_forecast(latitude: float, longitude: float, days: int = 3) -> List[Dict[str, Any]]:
...
def generate_directions(destination: str, latitude: float, longitude: float) -> Dict[str, Any]:
    steps = [
